...
def getConfig():
    ...
    # dataset
    parser.add_argument('--resize', '-i', default=256, type=int,
                        metavar='N', help='image size (default: 512)')
    parser.add_argument('--crop', '-cs', default=224, type=int,
    ...
    # model config
    parser.add_argument('--model', default='DENSE-NET-121', type=str,
                        help='model name')
    ...
    parser.add_argument('--ckpt', default='results/', type=str, metavar='checkpoint_path',
